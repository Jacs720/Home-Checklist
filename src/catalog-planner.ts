...
export function applyCatalogCorrections(entries: PokemonEntry[]) {
  ...
  let correctedEntries = correctSwShAlolanForms(correctBloodmoonUrsalunaDex(addSwShHisuianEvolutionEntries(expandCollectibleForms(uniqueFormIds))));
