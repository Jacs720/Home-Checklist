...
const FEATURE_EN: Copy = {
  ...
  generic_specimen: "Generic specimen", no_origin_required: "No specific origin required",
...
const FEATURE_ES: Copy = {
  ...
  generic_specimen: "Ejemplar genérico", no_origin_required: "No requiere una procedencia específica",
...
const FEATURE_LOCALIZED: Partial<Record<UiLanguage, Copy>> = {
  DEU: {
    ...
    generic_specimen: "Generisches Exemplar", no_origin_required: "Keine bestimmte Herkunft erforderlich",
  ...
  FRA: {
    ...
    generic_specimen: "Spécimen générique", no_origin_required: "Aucune provenance précise requise",
  ...
  ITA: {
    ...
    generic_specimen: "Esemplare generico", no_origin_required: "Nessuna provenienza specifica richiesta",
  ...
  JPN: {
    ...
    generic_specimen: "汎用個体", no_origin_required: "出身指定なし",
  ...
  KOR: {
    ...
    generic_specimen: "일반 개체", no_origin_required: "특정 출신 조건 없음",
  ...
  CHS: {
    ...
    generic_specimen: "通用个体", no_origin_required: "无特定来源要求",
  ...
  CHT: {
    ...
    generic_specimen: "通用個體", no_origin_required: "無特定來源要求",
