...
const FEATURE_EN: Copy = {
  ...
  home_challenges: "HOME CHALLENGES", home_challenges_only: "HOME Challenge species only", home_challenges_source: "HOME Challenges ↗", home_challenges_met: "HOME Challenges this Pokémon can fulfill", home_challenges_met_desc: "The exact challenge conditions are listed below; origin, form, gender, or trade requirements still apply.", historical_event_mythicals: "Historical event Mythicals",
...
const FEATURE_LOCALIZED: Partial<Record<UiLanguage, Copy>> = {
  DEU: {
    ...
    home_challenges: "HOME-HERAUSFORDERUNGEN", home_challenges_only: "Nur Arten aus HOME-Herausforderungen", home_challenges_met: "HOME-Herausforderungen für dieses Pokémon", home_challenges_met_desc: "Die genauen Bedingungen stehen unten; Herkunft, Form, Geschlecht oder Tausch bleiben erforderlich.", historical_event_mythicals: "Mysteriöse Pokémon aus früheren Events",
  ...
  JPN: {
    ...
    home_challenges: "HOMEチャレンジ", home_challenges_only: "HOMEチャレンジ対象種のみ", home_challenges_met: "このポケモンが対象のHOMEチャレンジ", home_challenges_met_desc: "各チャレンジの正確な条件です。出身・フォルム・性別・交換の条件も満たす必要があります。", historical_event_mythicals: "過去イベントの幻のポケモン",
  ...
  KOR: {
    ...
    home_challenges: "HOME 챌린지", home_challenges_only: "HOME 챌린지 대상 종만", home_challenges_met: "이 포켓몬으로 달성할 수 있는 HOME 챌린지", home_challenges_met_desc: "각 챌린지의 정확한 조건입니다. 출신·폼·성별·교환 조건도 충족해야 합니다.", historical_event_mythicals: "과거 이벤트 환상의 포켓몬",
  ...
  CHS: {
    ...
    home_challenges: "HOME 挑战", home_challenges_only: "仅限 HOME 挑战涉及的种类", home_challenges_met: "这只宝可梦可完成的 HOME 挑战", home_challenges_met_desc: "下方列出每项挑战的准确条件；仍须满足来源、形态、性别或交换要求。", historical_event_mythicals: "往期活动幻之宝可梦",
  ...
  CHT: {
    ...
    home_challenges: "HOME 挑戰", home_challenges_only: "僅限 HOME 挑戰涉及的種類", home_challenges_met: "這隻寶可夢可完成的 HOME 挑戰", home_challenges_met_desc: "下方列出每項挑戰的確切條件；仍須符合來源、形態、性別或交換要求。", historical_event_mythicals: "過往活動幻之寶可夢",
