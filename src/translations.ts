...
const FEATURE_EN: Copy = {
  ...
  home_challenges: "HOME CHALLENGES", home_challenges_only: "HOME Challenge species only", home_challenges_source: "HOME Challenges ↗", home_challenges_met: "HOME Challenges this Pokémon can fulfill", home_challenges_met_desc: "The exact challenge conditions are listed below; origin, form, gender, or trade requirements still apply.", historical_event_mythicals: "Event-distributed Mythical Pokémon",
  pokewalker: "POKÉWALKER", pokewalker_only: "Pokéwalker species only", pokewalker_only_desc: "View filter for the {count} species found through the Pokéwalker · does not add duplicate slots.", pokewalker_source: "Pokéwalker encounters ↗",
...
const FEATURE_ES: Copy = {
  ...
  home_challenges: "RETOS DE HOME", home_challenges_only: "Solo especies de retos de HOME", home_challenges_source: "Retos de HOME ↗", home_challenges_met: "Retos de HOME que puede cumplir", home_challenges_met_desc: "Se muestran las condiciones exactas de cada reto; siguen aplicando sus requisitos de origen, forma, sexo o intercambio.", historical_event_mythicals: "Pokémon míticos distribuidos por evento",
  pokewalker: "POKÉWALKER", pokewalker_only: "Solo especies del Pokéwalker", pokewalker_only_desc: "Filtro visual para las {count} especies encontradas mediante el Pokéwalker · no añade posiciones duplicadas.", pokewalker_source: "Encuentros del Pokéwalker ↗",
...
const FEATURE_LOCALIZED: Partial<Record<UiLanguage, Copy>> = {
  DEU: {
    ...
    home_challenges: "HOME-HERAUSFORDERUNGEN", home_challenges_only: "Nur Arten aus HOME-Herausforderungen", home_challenges_met: "HOME-Herausforderungen für dieses Pokémon", home_challenges_met_desc: "Die genauen Bedingungen stehen unten; Herkunft, Form, Geschlecht oder Tausch bleiben erforderlich.", historical_event_mythicals: "Per Event verteilte Mysteriöse Pokémon",
    pokewalker: "POKÉWALKER", pokewalker_only: "Nur Pokéwalker-Arten", pokewalker_only_desc: "Ansichtsfilter für die {count} über den Pokéwalker gefundenen Arten · fügt keine doppelten Plätze hinzu.", pokewalker_source: "Pokéwalker-Fundorte ↗",
  ...
  FRA: {
    ...
    home_challenges: "DÉFIS HOME", home_challenges_only: "Espèces des défis HOME uniquement", home_challenges_met: "Défis HOME réalisables avec ce Pokémon", home_challenges_met_desc: "Les conditions exactes sont indiquées ci-dessous ; les exigences d’origine, de forme, de sexe ou d’échange restent applicables.", historical_event_mythicals: "Pokémon fabuleux distribués par événement",
    pokewalker: "POKÉWALKER", pokewalker_only: "Espèces du Pokéwalker uniquement", pokewalker_only_desc: "Filtre d’affichage pour les {count} espèces trouvées via le Pokéwalker · n’ajoute aucun emplacement en double.", pokewalker_source: "Rencontres du Pokéwalker ↗",
  ...
  ITA: {
    ...
    home_challenges: "SFIDE HOME", home_challenges_only: "Solo specie delle sfide HOME", home_challenges_met: "Sfide HOME completabili con questo Pokémon", home_challenges_met_desc: "Le condizioni esatte sono elencate sotto; restano validi i requisiti di provenienza, forma, sesso o scambio.", historical_event_mythicals: "Pokémon misteriosi distribuiti tramite evento",
    pokewalker: "POKÉWALKER", pokewalker_only: "Solo specie del Pokéwalker", pokewalker_only_desc: "Filtro di visualizzazione per le {count} specie trovate tramite il Pokéwalker · non aggiunge slot duplicati.", pokewalker_source: "Incontri del Pokéwalker ↗",
  ...
  JPN: {
    ...
    home_challenges: "HOMEチャレンジ", home_challenges_only: "HOMEチャレンジ対象種のみ", home_challenges_met: "このポケモンが対象のHOMEチャレンジ", home_challenges_met_desc: "各チャレンジの正確な条件です。出身・フォルム・性別・交換の条件も満たす必要があります。", historical_event_mythicals: "イベントで配布された幻のポケモン",
    pokewalker: "ポケウォーカー", pokewalker_only: "ポケウォーカーのポケモンのみ", pokewalker_only_desc: "ポケウォーカーで見つかる{count}種類だけを表示 · 重複スロットは追加しません。", pokewalker_source: "ポケウォーカーの出現一覧 ↗",
  ...
  KOR: {
    ...
    home_challenges: "HOME 챌린지", home_challenges_only: "HOME 챌린지 대상 종만", home_challenges_met: "이 포켓몬으로 달성할 수 있는 HOME 챌린지", home_challenges_met_desc: "각 챌린지의 정확한 조건입니다. 출신·폼·성별·교환 조건도 충족해야 합니다.", historical_event_mythicals: "이벤트로 배포된 환상의 포켓몬",
    pokewalker: "포켓워커", pokewalker_only: "포켓워커 포켓몬만", pokewalker_only_desc: "포켓워커에서 만날 수 있는 {count}종만 표시 · 중복 슬롯은 추가하지 않습니다.", pokewalker_source: "포켓워커 출현 목록 ↗",
  ...
  CHS: {
    ...
    home_challenges: "HOME 挑战", home_challenges_only: "仅限 HOME 挑战涉及的种类", home_challenges_met: "这只宝可梦可完成的 HOME 挑战", home_challenges_met_desc: "下方列出每项挑战的准确条件；仍须满足来源、形态、性别或交换要求。", historical_event_mythicals: "通过活动配送的幻之宝可梦",
    pokewalker: "宝可计步器", pokewalker_only: "仅显示宝可计步器宝可梦", pokewalker_only_desc: "仅显示可通过宝可计步器遇到的 {count} 种宝可梦 · 不会添加重复位置。", pokewalker_source: "宝可计步器遭遇列表 ↗",
  ...
  CHT: {
    ...
    home_challenges: "HOME 挑戰", home_challenges_only: "僅限 HOME 挑戰涉及的種類", home_challenges_met: "這隻寶可夢可完成的 HOME 挑戰", home_challenges_met_desc: "下方列出每項挑戰的確切條件；仍須符合來源、形態、性別或交換要求。", historical_event_mythicals: "透過活動配信的幻之寶可夢",
    pokewalker: "寶可計步器", pokewalker_only: "僅顯示寶可計步器寶可夢", pokewalker_only_desc: "僅顯示可透過寶可計步器遇到的 {count} 種寶可夢 · 不會新增重複位置。", pokewalker_source: "寶可計步器遭遇清單 ↗",
