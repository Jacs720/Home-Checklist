...
const EN: Copy = {
  ...
  theme: "Theme", box_appearance: "BOX APPEARANCE", theme_title: "Choose a theme", theme_intro: "Use a classic wallpaper or create your own. Only the box area will change.", close_theme: "Close themes", apply_to: "APPLY TO", all_boxes: "All boxes", all_boxes_desc: "Also replaces exceptions", origin_mark_boxes: "This origin mark", this_box: "This box only", open_a_box: "Open a box to use this option", preview: "PREVIEW", theme_games: "Available games", original_theme: "Original", custom: "Custom", wallpaper: "Wallpaper", upload_background: "Upload a wallpaper", change_background: "Change wallpaper", theme_image_types: "PNG, JPG or WebP · 12 MB max.", app_color: "App color", primary_highlight: "Primary highlight", secondary_highlight: "Secondary highlight", custom_color_note: "These colors apply to the box surface and highlights; shiny and filter colors stay unchanged.", reset_original: "Restore original", apply_theme: "Apply theme", upload_to_continue: "Upload a wallpaper to continue", theme_image_error: "That image could not be prepared. Use a PNG, JPG or WebP up to 12 MB.", theme_storage_error: "This browser does not have enough space to save more custom themes.",
