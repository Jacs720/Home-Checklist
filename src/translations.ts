...
const FEATURE_EN: Copy = {
  ...
  home_challenges_only: "HOME Challenge species only", home_challenges_only_desc: "View filter for the {count} referenced species · does not add duplicate slots.", home_challenges_source: "HOME Challenges ↗",
...
const FEATURE_ES: Copy = {
  ...
  profile_forms_lite: "Living Form Lite", profile_forms_lite_desc: "Todas las formas almacenables, sin posiciones extra por diferencias de sexo.",
  profile_forms: "Living Dex de formas", profile_forms_desc: "Todas las formas almacenables y diferencias de sexo visibles.",
  profile_shiny: "Living Dex brillante", profile_shiny_desc: "Todos los brillantes posibles con tu EO.",
  ...
  home_challenges_only: "Solo especies de HOME Challenges", home_challenges_only_desc: "Filtro visual para las {count} especies referenciadas · no añade posiciones duplicadas.", home_challenges_source: "HOME Challenges ↗",
...
const FEATURE_LOCALIZED: Partial<Record<UiLanguage, Copy>> = {
  DEU: {
    ...
    profile_basic: "Einfacher Living Dex", profile_forms: "Formen-Living-Dex", profile_shiny: "Shiny-Living-Dex", profile_origin: "Herkunftszeichen-Living-Dex", profile_completionist: "Komplett", profile_custom: "Benutzerdefiniert",
  ...
  FRA: {
    ...
    profile_basic: "Living Dex de base", profile_forms: "Living Dex des formes", profile_shiny: "Living Dex chromatique", profile_origin: "Living Dex des marques d'origine", profile_completionist: "Complétionniste", profile_custom: "Personnalisé",
  ...
  ITA: {
    ...
    profile_basic: "Living Dex base", profile_forms: "Living Dex delle forme", profile_shiny: "Living Dex cromatico", profile_origin: "Living Dex dei simboli d'origine", profile_completionist: "Completista", profile_custom: "Personalizzato",
  ...
  JPN: {
    ...
    profile_basic: "基本リビング図鑑", profile_forms: "フォルムリビング図鑑", profile_shiny: "色違いリビング図鑑", profile_origin: "出身マーク別リビング図鑑", profile_completionist: "コンプリート", profile_custom: "カスタム",
  ...
  KOR: {
    ...
    profile_basic: "기본 리빙 덱스", profile_forms: "폼 리빙 덱스", profile_shiny: "이로치 리빙 덱스", profile_origin: "출신 마크 리빙 덱스", profile_completionist: "컴플리트", profile_custom: "사용자 지정",
  ...
  CHS: {
    ...
    profile_basic: "基础 Living Dex", profile_forms: "形态 Living Dex", profile_shiny: "异色 Living Dex", profile_origin: "来源标记 Living Dex", profile_completionist: "全收集", profile_custom: "自定义",
  ...
  CHT: {
    ...
    profile_basic: "基礎 Living Dex", profile_forms: "形態 Living Dex", profile_shiny: "異色 Living Dex", profile_origin: "來源標記 Living Dex", profile_completionist: "全收集", profile_custom: "自訂",
...
const GROUPS: Record<string, Partial<Record<UiLanguage, string>>> = {
  ...
  "profile-final": { "ES-LA": "Dex de fases finales", "ES-ES": "Dex de fases finales", ENG: "Final Form Dex" },
  "profile-regional": { "ES-LA": "Living Dex + formas regionales", "ES-ES": "Living Dex + formas regionales", ENG: "Living Dex + regional forms" },
  "profile-forms_lite": { "ES-LA": "Living Form Lite", "ES-ES": "Living Form Lite", ENG: "Living Form Lite" },
  "profile-noah": { "ES-LA": "Arca de Noé", "ES-ES": "Arca de Noé", ENG: "Noah's Ark" },
  "region-kanto": { "ES-LA": "Kanto", "ES-ES": "Kanto", ENG: "Kanto" },
  "region-johto": { "ES-LA": "Johto", "ES-ES": "Johto", ENG: "Johto" },
  "region-hoenn": { "ES-LA": "Hoenn", "ES-ES": "Hoenn", ENG: "Hoenn" },
  "region-sinnoh": { "ES-LA": "Sinnoh", "ES-ES": "Sinnoh", ENG: "Sinnoh" },
  "region-unova": { "ES-LA": "Teselia", "ES-ES": "Teselia", ENG: "Unova" },
  "region-kalos": { "ES-LA": "Kalos", "ES-ES": "Kalos", ENG: "Kalos" },
  "region-alola": { "ES-LA": "Alola", "ES-ES": "Alola", ENG: "Alola" },
  "region-galar": { "ES-LA": "Galar", "ES-ES": "Galar", ENG: "Galar" },
  "region-paldea": { "ES-LA": "Paldea", "ES-ES": "Paldea", ENG: "Paldea" },
};
...
export function copy(language: UiLanguage, key: string) {
  ...
  if (language === "ES-ES" && key === "profile_shiny") return "Living Dex variocolor";
  if (language === "ES-ES" && key === "shiny_available") return "Variocolor disponible";
  if (language === "ES-ES" && key === "shiny_locked") return "Variocolor bloqueado";
