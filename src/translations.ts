...
const FEATURE_EN: Copy = {
  ...
  home_challenges: "HOME CHALLENGES", home_challenges_only: "HOME Challenges", home_challenges_source: "HOME Challenges ↗", home_challenges_met: "HOME Challenges this Pokémon can fulfill", home_challenges_met_desc: "The exact challenge conditions are listed below; origin, form, gender, or trade requirements still apply.", historical_event_mythicals: "Event-exclusive Pokémon and Shinies",
  ...
  mightiest_mark: "Mightiest Mark", mightiest_source: "Mightiest Mark raids ↗", method_mightiest_raid: "Defeat and catch it in its seven-star Tera Raid event in Pokémon Scarlet or Violet.", why_mightiest_raid: "This exact species and form was available with the Mightiest Mark in an official seven-star Tera Raid event.", method_mightiest_mew: "Use Mew in the seven-star Mewtwo Tera Raid and successfully complete the battle.", why_mightiest_mew: "A Mew that participated in a successful battle against the Mightiest Mark Mewtwo received the Mightiest Mark when the raid ended.",
...
const FEATURE_ES: Copy = {
  ...
  mightiest_mark: "Emblema Imbatibilidad", mightiest_source: "Teraincursiones Imbatibles ↗", method_mightiest_raid: "Derrota y captura al Pokémon en su teraincursión de siete estrellas de Pokémon Escarlata o Púrpura.", why_mightiest_raid: "Esta especie y forma exactas estuvieron disponibles con el Emblema Imbatibilidad en una teraincursión oficial de siete estrellas.", method_mightiest_mew: "Usa a Mew en la teraincursión de siete estrellas de Mewtwo y completa el combate con éxito.", why_mightiest_mew: "Un Mew que participaba en un combate completado con éxito contra el Mewtwo con Emblema Imbatibilidad recibía el mismo emblema al finalizar la incursión.",
...
const FEATURE_LOCALIZED: Partial<Record<UiLanguage, Copy>> = {
  ...
  KOR: {
    ...
    home_challenges: "HOME 챌린지", home_challenges_only: "HOME 챌린지", home_challenges_met: "이 포켓몬으로 달성할 수 있는 HOME 챌린지", home_challenges_met_desc: "각 챌린지의 정확한 조건입니다. 출신·폼·성별·교환 조건도 충족해야 합니다.", historical_event_mythicals: "이벤트 한정 포켓몬과 색이 다른 포켓몬",
    pokewalker: "포켓워커", pokewalker_only: "포켓워커", pokewalker_only_desc: "포켓워커에서 만날 수 있는 {count}종만 표시 · 중복 슬롯은 추가하지 않습니다.", pokewalker_source: "포켓워커 출현 목록 ↗", mightiest_mark: "최강의증표", mightiest_source: "최강의증표 레이드 ↗", method_mightiest_raid: "포켓몬스터 스칼렛·바이올렛의 7성 테라 레이드배틀에서 쓰러뜨리고 잡습니다.", why_mightiest_raid: "이 포켓몬의 정확한 종류와 폼은 공식 7성 테라 레이드배틀에서 최강의증표와 함께 등장했습니다.", method_mightiest_mew: "뮤를 뮤츠의 7성 테라 레이드배틀에 참가시키고 승리하세요.", why_mightiest_mew: "최강의증표를 지닌 뮤츠와의 전투에 참가해 승리한 뮤는 레이드 종료 시 같은 증표를 받았습니다.", battle_bond_source: "유대변화 개굴닌자 체험판 ↗", battle_bond_ability: "유대변화", battle_bond_origin: "포켓몬스터 썬·문 특별체험판", method_battle_bond_demo: "포켓몬스터 썬·문 특별체험판을 완료하고 개굴닌자를 썬 또는 문의 정식 버전으로 보냅니다.", why_battle_bond_demo: "지우가 어버이이고 특성 유대변화를 지닌 이 수컷 개굴닌자는 포켓몬스터 썬·문 특별체험판에서만 얻을 수 있었습니다.",
  ...
  CHS: {
    ...
    home_challenges: "HOME 挑战", home_challenges_only: "HOME 挑战", home_challenges_met: "这只宝可梦可完成的 HOME 挑战", home_challenges_met_desc: "下方列出每项挑战的准确条件；仍须满足来源、形态、性别或交换要求。", historical_event_mythicals: "活动限定宝可梦与异色宝可梦",
    pokewalker: "宝可计步器", pokewalker_only: "宝可计步器", pokewalker_only_desc: "仅显示可通过宝可计步器遇到的 {count} 种宝可梦 · 不会添加重复位置。", pokewalker_source: "宝可计步器遭遇列表 ↗", mightiest_mark: "最强之证", mightiest_source: "最强之证太晶团体战 ↗", method_mightiest_raid: "在《宝可梦 朱／紫》的七星太晶团体战中击败并捕获这只宝可梦。", why_mightiest_raid: "该宝可梦的这一种类和形态曾在官方七星太晶团体战中携带最强之证登场。", method_mightiest_mew: "让梦幻参加超梦的七星太晶团体战并成功完成战斗。", why_mightiest_mew: "参加并成功完成与最强之证超梦的战斗后，梦幻会在团体战结束时获得相同的证章。", battle_bond_source: "牵绊变身甲贺忍蛙体验版 ↗", battle_bond_ability: "牵绊变身", battle_bond_origin: "《宝可梦 太阳／月亮》特别体验版", method_battle_bond_demo: "完成《宝可梦 太阳／月亮》特别体验版，并将其中的甲贺忍蛙传送到太阳或月亮的正式版。", why_battle_bond_demo: "这只雄性甲贺忍蛙的初训家为小智并拥有特性牵绊变身，只能通过《宝可梦 太阳／月亮》特别体验版获得。",
  ...
  CHT: {
    ...
    home_challenges: "HOME 挑戰", home_challenges_only: "HOME 挑戰", home_challenges_met: "這隻寶可夢可完成的 HOME 挑戰", home_challenges_met_desc: "下方列出每項挑戰的確切條件；仍須符合來源、形態、性別或交換要求。", historical_event_mythicals: "活動限定寶可夢與異色寶可夢",
    pokewalker: "寶可計步器", pokewalker_only: "寶可計步器", pokewalker_only_desc: "僅顯示可透過寶可計步器遇到的 {count} 種寶可夢 · 不會新增重複位置。", pokewalker_source: "寶可計步器遭遇清單 ↗", mightiest_mark: "最強之證", mightiest_source: "最強之證太晶團體戰 ↗", method_mightiest_raid: "在《寶可夢 朱／紫》的七星太晶團體戰中擊敗並捕捉這隻寶可夢。", why_mightiest_raid: "該寶可夢的這個種類與形態曾在官方七星太晶團體戰中帶有最強之證登場。", method_mightiest_mew: "讓夢幻參加超夢的七星太晶團體戰並成功完成戰鬥。", why_mightiest_mew: "參加並成功完成與最強之證超夢的戰鬥後，夢幻會在團體戰結束時獲得相同的證章。", battle_bond_source: "牽絆變身甲賀忍蛙體驗版 ↗", battle_bond_ability: "牽絆變身", battle_bond_origin: "《寶可夢 太陽／月亮》特別體驗版", method_battle_bond_demo: "完成《寶可夢 太陽／月亮》特別體驗版，並將其中的甲賀忍蛙傳送至太陽或月亮的正式版。", why_battle_bond_demo: "這隻雄性甲賀忍蛙的初訓家為小智並擁有特性牽絆變身，只能透過《寶可夢 太陽／月亮》特別體驗版取得。",
...
const GROUPS: Record<string, Partial<Record<UiLanguage, string>>> = {
  ...
  mighty: { "ES-LA": "Emblema Imbatibilidad", "ES-ES": "Emblema Imbatibilidad", ENG: "Mightiest Mark", DEU: "Unbezwingbarkeits-Zeichen", FRA: "Insigne Surpuissant", ITA: "Emblema della Forza Assoluta", JPN: "さいきょうのあかし", KOR: "최강의증표", CHS: "最强之证", CHT: "最強之證" },
